    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form @submit.prevent="productStore.addProduct(form)" class="space-y-4 md:space-y-6" action="#">
            <div>
            ...
            <div>
              ...
              <textarea v-model="form.description" id="description" name="description" rows="4"
                        ...
                        placeholder="Mango" ></textarea>
              <p i v-if="productStore.errors.description" class="mt-2 text-xs text-red-600 dark:text-red-400"><span
